...
class BaseUserManager(BaseUserManager):
    ...
    def create_user(self, email, password, first_name=None, middle_name=None, last_name=None, role=None):
        """
        ...
        user = CustomUser.create(email=self.normalize_email(email), password=password, first_name=first_name,
    ...
    def create_superuser(self, email, password, first_name=None, middle_name=None, last_name=None):
        """
        Creates and saves a superuser
        """
        user = self.create_user(email, password=password, first_name=first_name,
                                middle_name=middle_name, last_name=last_name, role=1)
        user.is_admin = True
        user.save(using=self._db)
        return user
